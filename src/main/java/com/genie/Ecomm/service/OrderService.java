...
public class OrderService {
    ...
    public OrderDTO placeOrder(Long userId, Map<Long, Integer> productQuantities, double totalAmount) {
        ...
        return new OrderDTO(orderSave.getId(),orderSave.getTotalAmount(),
                orderSave.getStatus(),orderSave.getOrderDate(),orderItemDTOS);
    }
    ...
    private OrderDTO convertToDTO(Orders orders) {
        ...
        List<OrderItemDTO> OrderItems = orders.getOrderItems().stream()
                .map(Item -> new OrderItemDTO(Item.getProduct().getName(),
